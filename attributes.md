...
from: https://wiki.johnkunz.com/index.php?title=VEX_Attribute_Glossary
...
## Copying and Instansing Attributes ##
...
Override the viewport display mode 
```
...
## For Loop Metadata ##
Detail attributes, You can get this information with a “Fetch metadata” Block Begin node.
```
